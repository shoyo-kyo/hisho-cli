(function(global) {
  ...
  module.exports = {
    ...
    config: (function() {
      var e;
      try {
        this._config = require(process.cwd() + '/.hisho/config.js');
      } catch (_error) {
        e = _error;
        return null;
      }
    ...
    getCompiler: function(type) {
      if (!this._compilers) {
        ...
        _.each(this.config.compiler.include, (function(_this) {
          return function(v, i) {
            var item, t, _i, _len, _ref, _results;
            item = require(_this.modulePath + "/" + v);
            _this._compilers.name[item.contentName] = item;
            _ref = item.contentType;
            _results = [];
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              t = _ref[_i];
              _results.push(_this._compilers.type[t] = item);
            }
            return _results;
          };
        })(this));
